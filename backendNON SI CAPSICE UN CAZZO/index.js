// Backend Express.js per Monkey Rider
...
const CONFIG = {
  PORT: 3000,
  JWT_SECRET: 'monkey_rider_university_secret_2025',
  // Configurazione dettagliata per PostgreSQL in Docker
  DB_CONFIG: {
    user: 'postgres',           // Utente postgres di default
    host: 'localhost',
    database: 'postgres',
    port: 5432,
  }
